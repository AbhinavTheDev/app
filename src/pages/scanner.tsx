...
import { Upload, Trash2, Pickaxe } from "lucide-react";

export default function Compost({ onBack }: { onBack: () => void }) {
  ...
  const classifyImage = async (imageUrl: string) => {
    ...
    try {
      ...
      const bestMaterial = Object.entries(materialProbs).reduce(
